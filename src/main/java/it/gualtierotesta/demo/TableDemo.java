...
public class TableDemo {
    ...
    private static void createFirstTable(final MainDocumentPart pMdp) {
        ...
        pMdp.getJaxbElement().getBody().getContent().add(tab);
    }

    private static void createSecondTable(final MainDocumentPart pMdp) {
